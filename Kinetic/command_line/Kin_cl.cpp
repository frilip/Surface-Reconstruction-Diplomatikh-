...
void parse_terminal(Parameters &parameters){
  std::cout << std::endl;
  ...
  while (input != "done") {
    if (input == "-data"){
      ...
      std::cin >> input;
      parameters.maximum_distance = stof(input);
    }
    else if (input == "-angle"){
      std::cin >> input;
      parameters.maximum_angle = stoi(input);
    }
    else if (input == "-kn"){
      std::cin >> input;
      parameters.k_neighbors = stoi(input);
    }
    else if (input == "-minp"){
      std::cin >> input;
      parameters.min_region_size = stoi(input);
    }
    else if (input == "-debug"){
      std::cin >> input;
      parameters.debug = input=="true" ? true : false;
    }
    else if (input == "-verbose"){
      std::cin >> input;
      parameters.verbose = input=="true" ? true : false;
    }
    else if (input == "-odepth"){
      std::cin >> input;
      parameters.max_octree_depth = stoi(input);
    }
    else if (input == "-osize"){
      std::cin >> input;
      parameters.max_octree_node_size = stoi(input);
    }
    else if (input == "-reorient"){
      std::cin >> input;
      parameters.reorient = input=="true" ? true : false;
    }
    else if (input == "-regparallel"){
      std::cin >> input;
      parameters.regparallel = input=="true" ? true : false;
    }
    else if (input == "-regcoplanar"){
      std::cin >> input;
      parameters.regcoplanar = input=="true" ? true : false;
    }
    else if (input == "-regorthogonal"){
      std::cin >> input;
      parameters.regorthogonal = input=="true" ? true : false;
    }
    else if (input == "-regsymmetric"){
      std::cin >> input;
      parameters.regsymmetric = input=="true" ? true : false;
    }
    else if (input == "-regangle"){
      std::cin >> input;
      parameters.angle_tolerance = stoi(input);
    }
    else if (input == "-regoff"){
      std::cin >> input;
      parameters.maximum_offset = stof(input);
    }
    else if (input == "-k"){
      std::cin >> input;
      parameters.k_intersections = stoi(input);
    }
    else if (input == "-lambda"){
      std::cin >> input;
      parameters.graphcut_lambda = stof(input);
    }
    else if (input == "-ground"){
      std::cin >> input;
      parameters.use_ground = input=="true" ? true : false;
    }
    else if (input == "-wnormals"){
      std::cin >> input;
      parameters.with_normals = input=="true" ? true : false;
    }
    else if (input == "-outname"){
      std::cin >> input;
      parameters.output_name = input;
    }
    else std::cout << "TYPO" << std::endl;
...
int main(const int argc, const char** argv) {
  ...
  parse_terminal(parameters);

  parameters.data = argc==1 ? "../../shared/CGAL-6.1/data/points_3/building.ply" : argv[1];
  ...
  if (polylist.size() > 0){
    non_empty = true;
    CGAL::IO::write_polygon_soup(parameters.output_name + "_" + std::to_string(parameters.graphcut_lambda) + (parameters.use_ground ? "_g" : "_") + ".ply", vtx, polylist);
  }
